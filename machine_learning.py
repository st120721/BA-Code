...
class Machine_Learning:
    ...
    sfs_param_space = {"k_features": hp.choice("k_features", np.arange(1, 8, 1, dtype=int).tolist()),
    ...
    rf_dict=dict(
        name ="RF",
        parameters_list=['max_depth', 'n_estimators', 'criterion'],
    ...
    def __init__(self,algorithm,scoring,loops, features, labels,folder_path):
        """
            Konstruktionsfunktion von der Klasse

            :param algorithm: der gewählten Algorithmus
            :param scoring: Kriterium für Hyperparameter
            :param features: Features nach Features Extraktion
            :param labels: Labels nach Features Extraktion
    ...
    def wirte_result_to_txt(self):
        """
            die besten Hyperparameter für das gewälten Kriterium in Txt speichern
        ...
        output_path = self.folder_path + "\\" + file_name
    ...
    def tuning_parameter(self):
        """
            ...
            :return result: Dictionary von Ergebnisse, das Hyperparameter, Dauer, Score usw. enthält
        """
...
class Scoring:
    """
        Die Klasse ist aufgebaut, um eine Liste von aller Kriterien.
        Zur zeit gibt es zwei Teile.
        Ein Teil ist für die zusammenfassende Kriterien vom Modell,z.B. accuracy,f1 score(macro),f1 score(micro) usw.
    ...
    def make_score(self):
        ...
        for i in np.arange(1,18,1,dtype=int):
...
#                     labels=labels,folder_path="test")
# test.main()
